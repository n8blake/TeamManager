...
`;
			...
			case 'Engineer':
				...
				information += `<p><img src="/assets/github.svg" alt="Github" width="32" height="32"> Github : <a href="https://github.com/${employee.getGithub()}">${employee.getGithub()}</a></p>
`;
				break;
			case 'Intern':
				icon = 'book.svg';
...
`;
		...
		return `<div class="card">
					<div class="card-header">
						<h3><img src="/assets/${icon}" alt="Github" width="32" height="32"> ${employee.getName()}</h3>

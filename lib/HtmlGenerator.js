...
`;
			...
			case 'Engineer':
				icon = 'clipboard-data';
				information += `<p><img src="../assets/github.svg" alt="Github" width="16" height="16" /> Github : <a href="https://github.com/${employee.getGithub()}" target="_blank">${employee.getGithub()}</a></p>
`;
				break;
			case 'Intern':
				icon = 'book';
...
`;
		...
		return `<div class="card">
					<div class="card-header">
						<h3><img src="../assets/${icon}.svg" alt="${icon}" width="22" height="22"> ${employee.getName()}</h3>
...
`;
	...
	saveHtmlDocument(fileName, html) { 
		const dir = `./src/${fileName}.html`;
		//console.log(dir);
		fs.writeFile(`./src/${fileName}.html`, html, (err) =>
